...
#define LV_USE_DRAW_DMA2D 0
    ...
    #define LV_DRAW_DMA2D_HAL_INCLUDE "stm32u5xx.h"
...
#define LV_ASSERT_HANDLER_INCLUDE <core/check.h>
#define LV_ASSERT_HANDLER furi_crash("LVGL Assert");
